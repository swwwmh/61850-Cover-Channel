...
if __name__ == "__main__":
    input_file = "IL001_P2_ML1001.txt"
    output_file = "IL001_P2_ML1001_mod.txt"
    # 示例32位二进制串（实际使用时请替换）
    bit_string = "11011100000010100000000000000001"
    
    process_network_packets(input_file, output_file, bit_string)
